...
As the MC increases in size, the best-fit MC can be seen to converge to data.
...
The two numbers in parenthesis in each entry correspond to $\Omega$ and $\Phi$, respectively.}
