...
In the case of small MC, a likelihood description that neglects MC uncertainties may lead to under-coverage even for a large data sample.
...
The ad hoc Poisson likelihood severely under-covers.
